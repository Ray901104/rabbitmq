...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding javaBinding(@Qualifier(value = "javaQueue") Queue javaQueue, FanoutExchange fanoutExchange) {
        return BindingBuilder.bind(javaQueue).to(fanoutExchange);
    }

    @Bean
    public Binding springBinding(@Qualifier(value = "springQueue") Queue springQueue, FanoutExchange fanoutExchange) {
        return BindingBuilder.bind(springQueue).to(fanoutExchange);
    }

    @Bean
    public Binding vueBinding(@Qualifier(value = "vueQueue") Queue vueQueue, FanoutExchange fanoutExchange) {
